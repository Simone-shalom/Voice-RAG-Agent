...
```bash
cd backend
python -m pytest tests/ -v       # 300 tests, all mocked (no real DB/API calls needed)
...
- **Test suite**: 300 tests, all mocked. Never require a running database or real API keys for tests.
